...
1. Set `KarasKino.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../KarasKino.Infrastructure/KarasKino.Infrastructure.csproj -s KarasKino.Api.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../KarasKino.Infrastructure/KarasKino.Infrastructure.csproj -s KarasKino.Api.csproj
```
